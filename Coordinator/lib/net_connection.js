 ...
 */
var NetConnection = module.exports = function(id, settings){
 ...
 * TODO: make publicly usable without sequence
 */
NetConnection.prototype.join = function(sequence, group) {
  this.__p.groups[sequence] = group;
};
 ...
 * TODO: make publicly usable without sequence
 */
NetConnection.prototype.leave = function(sequence) {
  var group = this.__p.groups[sequence];
  delete this.__p.groups[sequence];
  return group;
};
